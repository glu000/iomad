...
namespace theme_lambda2\privacy;
...
class provider implements
    ...
    const SITEBAR_STAT = 'theme_lambda2_sidebar';
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy_sidebar_closed', 'theme_lambda2');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy_sidebar_open', 'theme_lambda2');
            }
