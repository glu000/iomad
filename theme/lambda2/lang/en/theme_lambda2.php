...
<h2>Theme lambda2 - Responsive Theme for Moodle</h2>
</div>
<h4>Theme Summary</h4>
<div style="color: #888; text-transform: uppercase; margin-bottom:20px;">
<p>Compatibility: Moodle 2.5 - 3.6<br />Theme Version: 1.86<br />Parent theme: Bootstrapbase by Bas Brands<br />Built on: Essential by Julian Ridden</p>
</div>
<hr />
...
$string['block_icons'] = 'Theme lambda2 block icons';
