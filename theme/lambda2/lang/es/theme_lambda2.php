...
<h2>Tema lambda2 - Tema responsive para Moodle</h2>
</div>
<h4>Caracter&iacute;sticas del tema</h4>
<div style="color: #888; text-transform: uppercase; margin-bottom:20px;">
<p>Compatibilidad: Moodle 2.5 - 3.6<br />Versi&oacute;n del tema: 1.86<br />Tema matriz: Bootstrapbase de Bas Brands<br />Basado en: Essential de Julian Ridden</p>
</div>
<hr />
