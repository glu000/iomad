...
/* Core */
$string['configtitle'] = 'lambda2';
$string['pluginname'] = 'lambda2';
$string['choosereadme'] = '
<div class="clearfix">
<div style="margin-bottom:20px;">
<p style="text-align:center;"><img class="img-polaroid" src="lambda2/pix/screenshot.jpg" /></p>
</div>
<hr />
<div class="prom-box prom-box-default shadow2" style="margin-bottom:20px;">
<h2>Theme lambda2 - Thème adaptable pour Moodle</h2>
</div>
<h4>Résumé du thème</h4>
<div style="color: #888; text-transform: uppercase; margin-bottom:20px;">
<p>Compatibilité: Moodle 2.5 - 3.6<br />Version du thème : 1.86<br />Parent theme: Bootstrapbase by Bas Brands<br />Built on: Essential by Julian Ridden</p>
</div>
<hr />
<p style="text-align:center;"><img class="img-polaroid" src="lambda2/pix/redPIthemes.jpg" /></p>';
...
$string['block_icons'] = 'Icônes des blocs du thème lambda2';
...
$string['use_fa5_desc'] = 'Utiliser les nouvelles icônes web Font Awesome 5.<br /><strong>Note :</strong> Font Awesome version 5 a été complètement récrit et redessiné. Vous devez donc effectuer un certain nombre d\'opérations si vous avez déjà utilisé Font Awesome par le passé avec le thème lambda2. Il nécessaire de rechercher tous les noms des icônes de la version 4 qui ont un nom différent dans la version 5 et les remplacer par ces derniers. Veuillez svp vous référer au document <a href="https://fontawesome.com/how-to-use/upgrading-from-4#icon-name-changes" target="_blank">liste des icônes dont le nom a changé</a>.<br />Si c\'est la première fois que vous mettez le thème lambda2 en service, il est recommandé d\'utiliser directement la version 5 des icônes de Font Awesome.';
