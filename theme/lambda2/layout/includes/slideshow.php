...
if($PAGE->theme->settings->slideshow_height=='responsive') {
	if ($hasslideshow) {
		...
		list($width, $height) = theme_lambda2_getslidesize($slide_img_src);
...
<?php if ($shadow_effect) {
	if ($moodle_release > 2017051500) { ?>
		<div class="container-fluid"><img src="<?php echo $OUTPUT->image_url('bg/lambda2-shadow', 'theme'); ?>" class="lambda2-shadow" alt=""></div>
    <?php } else { ?>
		<div class="container-fluid"><img src="<?php echo $OUTPUT->pix_url('bg/lambda2-shadow', 'theme'); ?>" class="lambda2-shadow" alt=""></div>
<?php }} ?>
