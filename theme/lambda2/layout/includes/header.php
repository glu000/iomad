...
$searchbox = theme_lambda2_get_setting('navbar_search_form');
$login_link = theme_lambda2_get_setting('login_link');
$login_custom_url = theme_lambda2_get_setting('custom_login_link_url');
$login_custom_txt = theme_lambda2_get_setting('custom_login_link_txt');
$home_button = theme_lambda2_get_setting('home_button');
$shadow_effect = theme_lambda2_get_setting('shadow_effect');
$auth_googleoauth2 = theme_lambda2_get_setting('auth_googleoauth2');
        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse collapse">
                ...
                <form id="search" action="<?php if ($moodle_global_search) {echo $CFG->wwwroot.'/search/index.php';} else {echo $CFG->wwwroot.'/course/search.php';} ?>" >
                	<label for="coursesearchbox" class="lambda2-sr-only"><?php if ($moodle_global_search) {echo get_string('search', 'search');} else {echo get_string('searchcourses');} ?></label>						
					...
					<button type="submit"><span class="lambda2-sr-only"><?php echo get_string('submit'); ?></span></button>						
				</form>
                <?php } ?>
...
<?php if ($shadow_effect) {
	if ($moodle_release > 2017051500) { ?>
		<div class="container-fluid" style="background: #fff;"><img src="<?php echo $OUTPUT->image_url('bg/lambda2-shadow', 'theme'); ?>" class="lambda2-shadow" alt=""></div>
    <?php } else { ?>
		<div class="container-fluid" style="background: #fff;"><img src="<?php echo $OUTPUT->pix_url('bg/lambda2-shadow', 'theme'); ?>" class="lambda2-shadow" alt=""></div>
<?php }} ?>