...
$hide_breadrumb_setting = theme_lambda2_get_setting('hide_breadcrumb');
...
$sidebar = FALSE;
if ($PAGE->theme->settings->block_layout == 2) {$sidebar = TRUE; theme_lambda2_init_sidebar($PAGE); $sidebar_stat = theme_lambda2_get_sidebar_stat();}
...
<?php 
	$lambda2_body_attributes = 'columns2';
