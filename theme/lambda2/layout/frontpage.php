...
if ($sidebar) {theme_lambda2_init_sidebar($PAGE); $sidebar_stat = theme_lambda2_get_sidebar_stat();}
...
<head>
    ...
    <noscript>
			<link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/lambda2/style/nojs.css" />
	</noscript>
    <!-- Google web fonts -->
...
<?php 
	$lambda2_body_attributes = '';
	if ($sidebar) {$lambda2_body_attributes .= ' sidebar-enabled '.$sidebar_stat;}
?>
<body <?php echo $OUTPUT->body_attributes("$lambda2_body_attributes"); ?>>
...
<div id="page" class="container-fluid">
	...
	<div class="hidden-blocks">
    	<div class="row-fluid">
        	<h4><?php echo get_string('visibleadminonly', 'theme_lambda2') ?></h4>
            <?php
	...
	<a href="#top" class="back-to-top"><i class="fa fa-chevron-circle-up fa-3x"></i><span class="lambda2-sr-only"><?php echo get_string('back'); ?></span></a>
...
<!--[if lte IE 9]>
<script src="<?php echo $CFG->wwwroot;?>/theme/lambda2/javascript/ie/iefix.js"></script>
<![endif]-->
