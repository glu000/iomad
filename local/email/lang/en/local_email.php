...
$string['privacy:metadata:local_email:id'] = 'Email id';
$string['privacy:metadata:local_email:templatename'] = 'Email template name';
$string['privacy:metadata:local_email:sent'] = 'Email sent date';
$string['privacy:metadata:local_email:subject'] = 'Email subject';
$string['privacy:metadata:local_email:body'] = 'Email body';
$string['privacy:metadata:local_email:courseid'] = 'Email course id';
$string['privacy:metadata:local_email:userid'] = 'Email recipient id';
$string['privacy:metadata:local_email:invoiceid'] = 'Email invoice id';
$string['privacy:metadata:local_email:senderid'] = 'Email sender id';
$string['privacy:metadata:local_email:headers'] = 'Email headers';
$string['privacy:metadata:local_email'] = 'Email';
