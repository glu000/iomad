...
class user_edit_form extends company_moodleform {
    ...
    public function validation($usernew, $files) {
        ...
        // Validate email.
        if (empty($CFG->allowaccountssameemail) && $DB->record_exists('user', array('email' => $usernew->email, 'mnethostid' => $CFG->mnet_localhost_id))) {
        ...
        if (!empty($data->licensecourses)) {
            ...
            foreach ($data->licensecourses as $licensecourse) {
                ...
                if ($allow) {
                    ...
                    require ("$CFG->dirroot/force_enrol.php");
